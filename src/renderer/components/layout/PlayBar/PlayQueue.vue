      ...
      <div :class="$style.panel">
        <div :class="$style.header">
          ...
          <button :class="$style.headerBtn" :aria-label="$t('playlist_clear_played')" @click="handleClearPlayed">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" height="70%" viewBox="0 0 512 512" space="preserve">
        ...
        <div ref="dom_list" :class="['scroll', $style.content]">
          ...
          >
            <div :class="$style.index">
              <svg v-if="isActiveIndex(index)" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" height="60%" viewBox="0 0 512 512" space="preserve">
            ...
            <button :class="$style.removeBtn" :aria-label="$t('list__remove')" @click.stop="handleRemove(index)">
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" height="60%" viewBox="0 0 212.982 212.982" space="preserve">
...
:global(.play-queue-fade-enter-active),
:global(.play-queue-fade-leave-active) {
  transition: opacity .2s ease;
}
:global(.play-queue-fade-enter-from),
:global(.play-queue-fade-leave-to) {
  opacity: 0;
}
</style>
